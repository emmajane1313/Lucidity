  ...
  return (
    <div className="relative w-full h-fit flex flex-col items-center justify-between gap-3">
      ...
      <div className="relative w-full flex h-full ">
        <div
          className="relative w-full h-fit max-h-[20rem] overflow-y-scroll"
          id="target"
        >
          <InfiniteScroll
            ...
            loader={<div key={0} />}
            className={`relative w-full font-dep flex flex-col items-center justify-start gap-3 h-fit h-full`}
            ...
            {commentsLoading
              ? Array.from({ length: 10 }).map((_, indice) => {
                  return (
                    <div
                      key={indice}
                      className="relative w-full sm:w-1/2 rounded-md h-40 flex animate-pulse border border-brillo bg-black"
                    ></div>
                  );
                })
      ...
      <div className="relative w-full sm:w-1/2 flex flex-col items-center justify-center gap-4">
